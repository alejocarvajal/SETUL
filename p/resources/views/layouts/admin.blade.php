                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="{!!URL('/asignaturas/create') !!}"><i class='fa fa-plus fa-fw'></i> Agregar</a>
                                    </li>
                                    <li>
                                        <a href="{!!URL('/asignaturas') !!}"><i class='fa fa-list-ol fa-fw'></i> Asignaturas</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="{!!URL('/tests/create') !!}"><i class='fa fa-plus fa-fw'></i> Agregar</a>
                                    </li>
                                    <li>
                                        <a href="{!!URL('/tests') !!}"><i class='fa fa-list-ol fa-fw'></i> Tests</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="{!!URL('/preguntas/create') !!}"><i class='fa fa-plus fa-fw'></i> Agregar</a>
                                    </li>
                                    <li>
                                        <a href="{!!URL('/preguntas') !!}"><i class='fa fa-list-ol fa-fw'></i> Preguntas</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
